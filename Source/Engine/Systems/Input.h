...
namespace STR_FALL
{
	...
	public:
        ...
        Vector2 GetKeyDir(int posX, int negX, int posY, int negY) const { return Vector2(static_cast<float>(m_keyStates.at(posX) - m_keyStates.at(negX)), static_cast<float>(m_keyStates.at(posY) - m_keyStates.at(negY))); }
